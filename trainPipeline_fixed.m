...
saveCompactModel(models.kmeansModel, fullfile(outputDir,'kmeansModel.mat'));
saveCompactModel(models.ocsvmModel, fullfile(outputDir,'ocsvmModel.mat'));
if isfield(models,'supervisedModel')
    saveCompactModel(models.supervisedModel, fullfile(outputDir,'supervisedModel.mat'));
end
